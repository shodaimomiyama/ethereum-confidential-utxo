...
contract RangeProofVerifier {
    ...
    bytes32 internal constant PARAMETERS_TAG = keccak256("ecu/bp/parameters/v2");
    bytes32 internal constant Y_TAG = keccak256("ecu/bp/y/v2");
    bytes32 internal constant Z_TAG = keccak256("ecu/bp/z/v2");
    bytes32 internal constant X_TAG = keccak256("ecu/bp/x/v2");
    bytes32 internal constant U_TAG = keccak256("ecu/bp/u/v2");
    bytes32 internal constant ROUND_TAG = keccak256("ecu/bp/round/v2");
